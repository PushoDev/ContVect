<div class="modal fade bs-example-modal-lg" id="edit-pacientes-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;" data-backdrop="static">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <!-- Formulario -->
        <form class="modal-content tab-wizard wizard-circle id=" steps-uid-0" action="<?= route_to('update-paciente') ?>" method="post" id="update_paciente_form">
