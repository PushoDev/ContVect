<div class="right-sidebar">
	<div class="sidebar-title">
		<h3 class="weight-600 font-16 text-blue">
			...
			<span class="btn-block font-weight-400 font-12">Configurar Interfaz de Usuario</span>
		</h3>
	...
	<div class="right-sidebar-body customscroll">
		<div class="right-sidebar-body-content">
			<h4 class="weight-600 font-18 pb-10">Barra Superior</h4>
			...
			<h4 class="weight-600 font-18 pb-10">Listado del Menú</h4>
